...
export default function Hero({ onOpenContact }: HeroProps) {
  return (
    <section className="relative min-h-[95vh] sm:min-h-screen flex flex-col justify-between items-center pt-28 sm:pt-36 pb-6 px-4 sm:px-6 overflow-hidden bg-[linear-gradient(180deg,#0B1020_0%,#0F172A_100%)]">
      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col items-center text-center my-auto z-10 -translate-y-4 sm:-translate-y-8">
        {/* Category Badges */}
        ...
        {/* Action Buttons: wider, slightly less height, rounded-[10px] */}
        ...
        {/* Logo blanc animé directement en bas de ce bloc div */}
        <div className="relative -mt-4 sm:-mt-8 w-full flex justify-center pointer-events-none select-none z-0">
          <div className="w-[340px] sm:w-[480px] md:w-[600px] lg:w-[680px] opacity-30 blur-[3px] animate-logo-float drop-shadow-[0_0_40px_rgba(255,255,255,0.2)]">
